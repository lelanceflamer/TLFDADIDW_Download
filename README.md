 NOUVELLE VERSION: TE/3.5.7 - Lisez-ceci: Release de la [version 3.5.7](https://github.com/LlFPrograms/TLFDADIDW/releases/tag/v3.5.7) - Nouveautées:
 ...
 *.dll avec des images. (Programme fait en Visual C# dans [![Visual Studio Community 2019](https://s18955.pcdn.co/wp-content/uploads/2018/02/github.png)](https://visualstudio.microsoft.com/fr/vs/older-downloads/) (Maintenant 2022)!)). Des fautes d'orthographes sont trouvables (surtout dans les premières versions, et dans le formulaire "Journal des 
 mises à jour").
